...
class Manifest_model extends App_Model
{
    ...
    public function get_records($manifest_number = null, $branch_ids = null)
    {
        ...
        if ($branch_ids !== null) {
            $this->db->where_in(db_prefix() . '_manifests.branch_id', !empty($branch_ids) ? (array) $branch_ids : [0]);
        }
    ...
    public function get_manifests($branch_ids = null)
    {

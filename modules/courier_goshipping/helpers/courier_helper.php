    ...
    function _courier_pdf_terms_html()
    {
        return '
            ...
            <table cellpadding="2" style="width:100%;margin-top:2px;">
                <tr>
                    <td style="width:50%;font-size:7.5px;vertical-align:top;border:none;line-height:1.4;color:#0d47a1;">
...
if (!function_exists('courier_generate_waybill_pdf')) {
    function courier_generate_waybill_pdf($shipment_id)
    {
        try {
            ...
            // #333 borders, plain black text on both labels AND values. No
            // color anywhere in this table; the only color in the whole
            // document is the card's blue/red border, which is the one
            // thing actually confirmed in waybill.php's own inline style.

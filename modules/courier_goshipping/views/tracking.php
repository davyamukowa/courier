...
$tab_urls = [
    'track'    => base_url('courier_goshipping/track'),
    'quote'    => base_url('courier_goshipping/get-a-quote'),
    'pickup'   => base_url('courier_goshipping/schedule-delivery'),
    'service'  => base_url('courier_goshipping/find-service-point'),
    'shipment' => base_url('courier_goshipping/create-shipment'),
    'call'     => base_url('courier_goshipping/call-for-booking'),
];
?>
<div class="tabs-bar">
...
<script>
    ...
    var QUOTE_EMAIL_URL   = '<?php echo base_url("courier_goshipping/portal/send_quote_email"); ?>';
    var COUNTRIES_URL     = '<?php echo base_url("courier_goshipping/portal/get_countries"); ?>';
    var CITIES_URL        = '<?php echo base_url("courier_goshipping/portal/get_cities"); ?>';
    var DOMESTIC_CITIES_URL = '<?php echo base_url("courier_goshipping/portal/get_domestic_cities"); ?>';
    ...
    function trackShipment(trackingNumber) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_goshipping/tracking/shipment_info"); ?>',
            type: 'POST',
    ...
    $('#public-pickup-form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_goshipping/portal/store_pickup"); ?>',
            type: 'POST',
            data: form.serialize(),
            dataType: 'json',
            success: function (r) {
    ...
    $('#public-shipment-form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_goshipping/portal/store_shipment"); ?>',
            type: 'POST',

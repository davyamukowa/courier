...
$status_cards = [
    ...
    ['id'=>'5', 'label'=>'Local Delivery - In Transit', 'icon'=>'fa-shipping-fast',   'color'=>'courier-stat-purple', ],
...
?>
<?php $this->load->view('courier_goshipping/shipments/_page_header', ['header_context' => 'dashboard', 'shipment_counts' => $shipment_counts ?? []]); ?>
<style>
.sh-overview .btn,
...
<div class="sh-overview">
    <div class="sh-total-bar">
        ...
        <a href="<?php echo admin_url('courier_goshipping/shipments?type=domestic'); ?>" class="btn btn-primary">View All</a>
    </div>

...
$pay_url_js      = admin_url('courier_goshipping/shipments/record_courier_payment/' . $shipment_id_js);
$inv_email_url   = admin_url('courier_goshipping/shipments/send_invoice_email/' . $shipment_id_js);
$rcp_email_url   = admin_url('courier_goshipping/shipments/send_payment_receipt_email/' . $shipment_id_js);
...
<div class="ci-actions-card">
    ...
    <a class="ci-action-btn ghost" href="<?php echo admin_url('courier_goshipping/shipments/waybill/' . $shipment_details['shipment']->id); ?>">

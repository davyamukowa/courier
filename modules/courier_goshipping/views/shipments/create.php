...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var POD_SP_JSON_URL = '<?php echo admin_url("courier_goshipping/settings/service_points_json"); ?>';
...
<?php $this->load->view('courier_goshipping/layout/_topnav', ['cgs_active' => 'shipments']); ?>
        ...
        <div class="row">
            <?php echo form_open(admin_url('courier_goshipping/shipments/store'), [
                    ...
                    <div style="width:100%;" class="panel-body">
                        <div style="margin-bottom:25px">
                            <a class="custom-button custom-button-green"
                               href="<?php echo admin_url('courier_goshipping/shipments/main'); ?>">
...
function saveLogisticCompany() {
    ...
    $.ajax({
        url: '<?php echo admin_url("courier_goshipping/shipments/save_logistic_company"); ?>',
        type: 'POST',
        data: {
...
<script>
    ...
    $(document).ready(function () {
        ...
        function getStates(countryId, section, stateDropdown, stateId) {
            if (countryId) {
                $.ajax({
                    url: '<?php echo admin_url("courier_goshipping/states"); ?>',
                    type: "GET",
                    data: {country_id: countryId},
                    dataType: "json",

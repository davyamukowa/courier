...
<div id="mb-wrapper">
    ...
    <div class="mb-topbar mb-no-print">
        ...
        <a href="<?php echo admin_url('courier_goshipping/shipments?type=domestic'); ?>" class="mb-btn mb-btn-back">
            <i class="fa fa-arrow-left"></i> Shipment List
        </a>
        <a href="<?php echo admin_url('courier_goshipping/shipments/create?type=domestic'); ?>" class="mb-btn" style="background:linear-gradient(135deg,<?php echo $mc; ?>,<?php echo $mc; ?>cc);color:#fff;">
...
function sendMbEmail(){
    ...
    $.ajax({url:'<?php echo admin_url("courier_goshipping/shipments/send_manifest_email"); ?>',type:'POST',

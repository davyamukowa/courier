...
<style>
.sp-card { background:var(--cgs-surface-card,#fff); border:1px solid var(--cgs-border,#e0e0e0); border-radius:var(--cgs-radius-md,6px); padding:20px 24px; margin-bottom:20px; }
...
.sp-badge { display:inline-block; background:var(--cgs-primary-light,#eaf1f8); color:var(--cgs-primary-dark,#2c5580); border:1px solid var(--cgs-primary,#3a6ea5); border-radius:12px; font-size:11px; font-weight:600; padding:2px 10px; margin:3px 3px; }
.sp-delete-btn { background:none; border:none; color:var(--cgs-secondary,#c1272d); cursor:pointer; font-size:13px; padding:2px 6px; }
.sp-delete-btn:hover { color:var(--cgs-secondary-dark,#9c1f24); }
...
.sp-country-tag { font-size:11px; color:var(--cgs-primary-dark,#2c5580); background:var(--cgs-primary-light,#eaf1f8); border:1px solid var(--cgs-primary,#3a6ea5); border-radius:10px; padding:1px 8px; margin-right:10px; white-space:nowrap; }
.upload-note { font-size:12px; color:#888; margin-top:6px; }
</style>

<div class="sp-card">
    <h4><i class="fa fa-map-marker" style="color:var(--cgs-primary,#3a6ea5);margin-right:6px;"></i> Add Service Point</h4>
    <div class="row">
        ...
        <div class="col-md-6" style="margin-bottom:10px;">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="cgs-btn cgs-btn--primary" id="btnAddSp">
...
<div class="sp-card">
    <h4><i class="fa fa-upload" style="color:var(--cgs-primary,#3a6ea5);margin-right:6px;"></i> Bulk Upload via CSV</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-2" style="padding-top:22px;">
            <button class="cgs-btn cgs-btn--primary" id="btnUploadCsv">
...
<div class="sp-card">
    <h4>
        ...
        <span id="spCount" class="badge" style="margin-left:8px;background:var(--cgs-primary,#3a6ea5);"><?php echo count($service_points); ?></span>
    </h4>
...
<script>
var CI_BASE_URL = '<?php echo admin_url("courier_goshipping/settings/"); ?>';
...
function showMsg(el, msg, ok) {
    el.innerHTML = msg;
    el.style.color = ok ? 'var(--cgs-primary-dark, #2c5580)' : 'var(--cgs-secondary, #c1272d)';
}

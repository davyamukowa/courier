    ...
    <div class="col-md-12">
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <button style="margin-top:20px;" type="submit" class="cgs-btn cgs-btn--primary">Save General Settings</button>
            </div>
        </div>
    </div>
            ...
            <div class="panel-body">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(190px,1fr));gap:14px;margin-bottom:20px;" id="cn-tpl-grid">
                    ...
                    <label style="cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px 12px;
                        border:2px solid <?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary)' : '#ddd'; ?>;
                        border-radius:8px;background:<?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary-light)' : '#fafafa'; ?>;
                        ...
                        <i class="fa <?php echo $tpl['icon']; ?>" style="font-size:26px;color:<?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary)' : '#888'; ?>;" id="cn-icon-<?php echo $slug; ?>"></i>
                        <strong style="font-size:13px;color:<?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary-dark)' : '#333'; ?>;text-align:center;" id="cn-label-<?php echo $slug; ?>"><?php echo $tpl['label']; ?></strong>
                        <small class="text-muted" style="font-size:11px;text-align:center;line-height:1.4;"><?php echo $tpl['desc']; ?></small>
                        <span style="font-size:10px;font-weight:700;color:<?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary-dark)' : '#aaa'; ?>;background:<?php echo $cur_cn_tpl === $slug ? 'var(--cgs-primary-light)' : 'transparent'; ?>;border-radius:10px;padding:2px 10px;" id="cn-active-<?php echo $slug; ?>"><?php echo $cur_cn_tpl === $slug ? '&#10003; Active' : '&nbsp;'; ?></span>
                    </label>
                    <?php endforeach; ?>
                </div>
                <button type="submit" class="cgs-btn cgs-btn--primary">Save General Settings</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <button style="margin-top:16px;" type="submit" class="cgs-btn cgs-btn--primary">Save General Settings</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <button type="submit" class="cgs-btn cgs-btn--primary" style="margin-top:10px;">Save General Settings</button>
            </div>
        </div>
    </div>
        ...
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <div style="display:grid; grid-template-columns:repeat(auto-fill,minmax(200px,1fr)); gap:14px; margin-bottom:20px;" id="manifest-tpl-grid">
                    ...
                    <label style="cursor:pointer; display:flex; flex-direction:column; align-items:center; gap:8px; padding:16px 12px; border:2px solid <?php echo $cur_tpl === $slug ? 'var(--cgs-primary)' : '#ddd'; ?>; border-radius:8px; background:<?php echo $cur_tpl === $slug ? 'var(--cgs-primary-light)' : '#fafafa'; ?>; transition:.2s;" id="tpl-card-<?php echo $slug; ?>">
                        ...
                        <i class="fa <?php echo $tpl['icon']; ?>" style="font-size:26px; color:<?php echo $cur_tpl === $slug ? 'var(--cgs-primary)' : '#888'; ?>;" id="tpl-icon-<?php echo $slug; ?>"></i>
                        <strong style="font-size:13px; color:<?php echo $cur_tpl === $slug ? 'var(--cgs-primary-dark)' : '#333'; ?>; text-align:center;" id="tpl-label-<?php echo $slug; ?>"><?php echo $tpl['label']; ?></strong>
                        <small class="text-muted" style="font-size:11px; text-align:center; line-height:1.4;"><?php echo $tpl['desc']; ?></small>
                        <?php if ($cur_tpl === $slug): ?>
                        <span style="font-size:10px; font-weight:700; color:var(--cgs-primary-dark); background:var(--cgs-primary-light); border-radius:10px; padding:2px 10px;" id="tpl-active-<?php echo $slug; ?>">&#10003; Active</span>
                        <?php else: ?>
...
function selectCnCard(slug) {
    _cnSlugs.forEach(function(s) {
        ...
        var active = (s === slug);
        card.style.borderColor  = active ? 'var(--cgs-primary)' : '#ddd';
        card.style.background   = active ? 'var(--cgs-primary-light)' : '#fafafa';
        icon.style.color        = active ? 'var(--cgs-primary)' : '#888';
        label.style.color       = active ? 'var(--cgs-primary-dark)' : '#333';
        badge.style.color       = active ? 'var(--cgs-primary-dark)' : '#aaa';
        badge.style.background  = active ? 'var(--cgs-primary-light)' : 'transparent';
    ...
    <div class="col-md-12">
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <button style="margin-top:20px;" type="submit" class="cgs-btn cgs-btn--primary">Save Weight Factors</button>
            </div>
        </div>
    </div>
    <?php echo form_close(); ?>
    ...
    <div class="col-md-12">
        <div class="panel_s">
            ...
            <div class="panel-body">
                ...
                <button type="submit" class="cgs-btn cgs-btn--primary">Save Freight Rates</button>
            </div>
        </div>
    </div>
    <?php echo form_close(); ?>

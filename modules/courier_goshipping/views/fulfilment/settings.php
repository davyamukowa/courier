    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="webhooks">
                ...
                <div class="mbot20">
                    <?php echo form_open(admin_url('courier_goshipping/fulfilment/register_webhooks'), ['class' => 'inline-block']); ?>
                    <button type="submit" class="btn btn-success">Register All Webhooks</button>
                    <?php echo form_close(); ?>

                    <?php echo form_open(admin_url('courier_goshipping/fulfilment/delete_webhooks'), ['class' => 'inline-block mleft10']); ?>
...
(function waitForJQueryFulfilmentSettings() {
    ...
    $(function () {
        ...
        var mappingsTable = $('#product-mappings-table').DataTable({
            ajax: admin_url + 'courier_goshipping/fulfilment/get_product_mappings',
            columns: [
        ...
        $('#btn-save-mapping').on('click', function () {
            $.post(admin_url + 'courier_goshipping/fulfilment/save_product_mapping', $('#productMappingForm').serialize(), function (res) {
                if (!res.success) {
        ...
        $('#product-mappings-table').on('click', '.delete-mapping', function (e) {
            ...
            $.post(admin_url + 'courier_goshipping/fulfilment/delete_product_mapping/' + $(this).data('id'), function (res) {
                if (!res.success) {
        ...
        $('#btn-sync-locations').on('click', function () {
            var $btn = $(this);
            $btn.prop('disabled', true);
            $.post(admin_url + 'courier_goshipping/fulfilment/sync_shopify_locations', function (res) {
        ...
        $(document).on('change', '.location-branch-select', function () {
            var $select = $(this);
            $.post(admin_url + 'courier_goshipping/fulfilment/save_location_branch_map', {
                id: $select.data('id'),

            ...
            <div class="col-md-12">
                <div class="cgs-card">
                        <div class="cgs-card__header">
                            <h4 class="cgs-card__title"><i class="fa fa-file-text-o"></i> GO Shipping Cargo — Manifests</h4>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="margin-right:6px; margin-top:5px;"
                                       href="<?php echo admin_url('courier_goshipping/manifests/view/' . $manifest->manifest_number); ?>"

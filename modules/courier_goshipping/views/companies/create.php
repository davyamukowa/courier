    ...
    <div class="col-md-12">
        <div class="cgs-card">
                <div class="cgs-card__header">
                    <h4 class="cgs-card__title"><i class="fa fa-building"></i> GO Shipping Cargo — Create Company</h4>
                    <div class="cgs-card__actions">
                        <a class="cgs-btn cgs-btn--outline" href="<?php echo admin_url('courier_goshipping/companies/main?group=list_companies'); ?>">
                            View Companies
                        </a>
                    </div>
                </div>

...
foreach ($rResult as $aRow) {
    ...
    $options .= '<a href="' . admin_url('whatsbot/view_log_details/') . $aRow['id'] . '" class="btn btn-default btn-icon"><i class="fa fa-eye"></i></a>';

    if (staff_can('clear_log', 'wtc_log_activity')) {
        $options .= '<a href="' . admin_url('whatsbot/delete_log/' . $aRow['id']) . '" data-id="' . $aRow['id'] . '" class="btn btn-default btn-icon btn-lg _delete"><i class="fa-regular fa-trash-can"></i></a>';
    }

...
<div class="tw-flex tw-flex-col">
    ...
    <!-- Stripe Checkout Flow Setting -->
    <?php
    $stripe_checkout_flow_key = 'perfex_saas_stripe_checkout_flow';
    $stripe_checkout_flow_value = get_option($stripe_checkout_flow_key);
    echo render_select(
        'settings[' . $stripe_checkout_flow_key . ']',
        [
            ['key' => 'setup', 'label' => _l('perfex_saas_stripe_checkout_flow_setup')],
            ['key' => 'subscription', 'label' => _l('perfex_saas_stripe_checkout_flow_subscription')],
        ],
        ['key', ['label']],
        perfex_saas_input_label_with_hint($stripe_checkout_flow_key),
        empty($stripe_checkout_flow_value) ? 'setup' : $stripe_checkout_flow_value
    );
    ?>

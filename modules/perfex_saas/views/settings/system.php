            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        ?>
                            <div class="text-center tw-mt-5 downloader">
                        ...
                        ?>
                            <div class="panel_s tw-p-4 tw-py-2 tw-bg-neutral-100">
                                <div class="panel_body tw-flex tw-flex-col tw-items-center tw-justify-center text-center tw-gap-3 tw-h-full tw-relative">
                                    ...
                                    <div class="tw-text-xl tw-w-full tw-mt-4 tw-grid tw-gap-3 tw-grid-cols-<?= $installed_module && !isset($module->purchase) ? '2' : '1'; ?>">

                                        <?php if (!$installed_module && isset($module->purchase)) : ?>
                                            <a target="_blank" href="<?= $module->purchase->cta_link; ?>" class="btn btn-primary btn-block"><?= $module->purchase->cta_text; ?></a>
                                        <?php endif; ?>

                                        <?php if (!isset($module->purchase)) : ?>

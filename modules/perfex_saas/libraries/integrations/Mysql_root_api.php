...
class Mysql_root_api
{
    ...
    public function testConnection($testUserCreation = true)
    {
        ...
        if ($this->conn !== null) {
            ...
            if ($testUserCreation) {
                ...
                $databaseCreated = $this->createDatabaseUser($testDbName, $this->generateStrongMysqlPassword());
    ...
    /**
     * Generate a cryptographically secure MySQL-safe password.
     *
     * Guarantees:
     * - Total length = $length (default 24)
     ...
     * - Automated provisioning / installers
     */
    function generateStrongMysqlPassword($length = 24)
    {
        ...
        // Fill remaining positions with fully mixed chars

...
<div class="xb-report-filters">
  <form method="get" class="xb-filters">
    ...
    <a href="<?php echo admin_url('xetuu_books/report_export?report=aged_payable&date_to=' . ($filters['date_to'] ?? date('Y-m-d'))); ?>" class="xb-btn xb-btn-secondary xb-btn-sm">Export CSV</a>
  </form>
</div>

<div class="xb-report">
  <h3 class="xb-report-heading">Aged Payable — As of <?php echo _d($filters['date_to'] ?? date('Y-m-d')); ?></h3>
  <table class="xb-table xb-report-table">
    ...
    <tbody>
      ...
      if (empty($rows)): ?>
      <tr><td colspan="7" class="xb-empty">No outstanding payables.</td></tr>

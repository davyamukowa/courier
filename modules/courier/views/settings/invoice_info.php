...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div style="margin-top:22px;">
            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Save Invoice Info</button>
            <a href="<?php echo admin_url('settings?group=company'); ?>" class="btn btn-default" style="margin-left:8px;" target="_blank">
...
<div class="panel panel-default" style="margin-top:24px;">
    ...
    <div class="panel-body">
        ...
        <div style="margin-top:22px;">
            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Save Stamp Settings</button>
        </div>
    </div>
</div>

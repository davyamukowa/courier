...
<div id="mf-wrapper">
    ...
    <div class="mf-topbar mf-no-print">
        <div class="mf-topbar-left">
            ...
            <a href="<?php echo admin_url('courier/shipments?type=domestic'); ?>" class="mf-btn mf-btn-back">
                <i class="fa fa-arrow-left"></i> Shipment List
            </a>
            <a href="<?php echo admin_url('courier/shipments/create?type=domestic'); ?>" class="mf-btn mf-btn-create">
...
function sendManifestEmail() {
    ...
    $.ajax({
        url: '<?php echo admin_url("courier/shipments/send_manifest_email"); ?>',
        type: 'POST',
        data: {
...
var ROUTES_URL      = '<?php echo admin_url("courier/shipments/get_routes"); ?>';
var STOPS_URL_BASE  = '<?php echo admin_url("courier/shipments/get_route_stops"); ?>';
var SAVE_ROUTE_URL  = '<?php echo admin_url("courier/shipments/save_route"); ?>';
var DEL_ROUTE_URL   = '<?php echo admin_url("courier/shipments/delete_route"); ?>';
var SAVE_STOPS_URL  = '<?php echo admin_url("courier/shipments/save_route_stops"); ?>';

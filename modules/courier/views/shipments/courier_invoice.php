...
$pay_url_js      = admin_url('courier/shipments/record_courier_payment/' . $shipment_id_js);
$inv_email_url   = admin_url('courier/shipments/send_invoice_email/' . $shipment_id_js);
$rcp_email_url   = admin_url('courier/shipments/send_payment_receipt_email/' . $shipment_id_js);
...
<div class="ci-actions-card">
    ...
    <a class="ci-action-btn ghost" href="<?php echo admin_url('courier/shipments/waybill/' . $shipment_details['shipment']->id); ?>">
...
<div class="receipt-wrapper">
    ...
    <div class="receipt-body" id="thermalReceipt">
        ...
        } elseif (!empty($shipment_details['packages'])) {
        ...
        <div class="rc-section-hdr">Items / Value</div>
        <?php
        ...
        // 2. packages with unit_price > 0              (domestic with declared value)
        // 3. packages regardless                       (at least show what was shipped)

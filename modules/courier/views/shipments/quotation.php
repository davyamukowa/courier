...
@media print {
    ...
    #wrapper > .content > .row > div:first-child { display:none!important; }
...
<div class="doc-page">
    ...
    <div class="action-bar">
        ...
        <a class="btn-back" href="<?php echo admin_url('courier/shipments/waybill/' . $shipment_details['shipment']->id); ?>">

                    ...
                    <div class="panel-body">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                            <h4 style="margin:0; font-weight:700;">
                                <i class="fa fa-file-invoice" style="color:#e65100;"></i>
                                Commercial Invoices
                            </h4>
                            <a href="<?php echo admin_url('courier/shipments/main'); ?>"
                        ...
                        <?php else: ?>
                            <table class="table dt-table" id="ciTable"
                                ...
                                <?php foreach ($commercial_invoices as $ci): ?>
                                    ...
                                    $ci_url = !empty($ci->commercial_invoice_url)
                                        ...
                                        : admin_url('courier/shipments/commercial_invoice/' . $ci->id);
                                    $ci_target = !empty($ci->commercial_invoice_url) ? ' target="_blank"' : '';
                                    ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo admin_url('courier/shipments/waybill/' . $ci->id); ?>"

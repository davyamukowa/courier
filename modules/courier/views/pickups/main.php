            ...
            <div class="col-md-3">
                <div class="courier-sidebar">
                    ...
                    <nav class="courier-sidebar-nav">
                        ...
                        <a href="<?php echo admin_url('courier/pickups/main?group=dashboard'); ?>" class="courier-nav-item">
                            <i class="fa fa-tachometer"></i> Dashboard
                        </a>
                        <a href="<?php echo admin_url('courier/pickups/create'); ?>" class="courier-nav-item">
                            <i class="fa fa-plus-circle"></i> Create Pickup
                        </a>
                        <div class="courier-nav-divider"></div>
                        <?php endif; ?>
                        <a href="<?php echo admin_url('courier/pickups'); ?>" class="courier-nav-item">

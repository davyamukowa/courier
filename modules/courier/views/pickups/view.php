...
<div id="wrapper">
    <div class="content" style="padding: 20px 30px;">
        ...
        <div class="exec-dashboard-header">
            <div>
                <h2>Pickup Request #<?php echo $pickup['id'] ?? ''; ?></h2>
                <p>Real-time overview of pickup logistics and analytics.</p>
            </div>
            <div>
                <a href="<?php echo admin_url('courier/pickups'); ?>" class="btn btn-default" style="border-radius: 6px; font-weight: 600;">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-value">
                            <?php if(!empty($pickup['shipment_id'])): ?>
                                <a href="<?php echo admin_url('courier/shipments/view/'.$pickup['shipment_id']); ?>" style="font-weight:700;">#<?php echo $pickup['shipment_id']; ?></a>
                            <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <div class="signature-box">
                                ...
                                <?php if (!empty($pickup['signature_url'])): ?>
                                    <img src="<?php echo base_url('modules/courier/' . $pickup['signature_url']); ?>" />
                                <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <div class="signature-box">
                                ...
                                <?php if (!empty($pickup['delivery_signature_url'])): ?>
                                    <img src="<?php echo base_url('modules/courier/' . $pickup['delivery_signature_url']); ?>" />
                                <?php else: ?>
                                    <p class="text-muted" style="margin:20px 0;"><small>Pending</small></p>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div id="signatureCanvasP" style="display:none; margin-bottom:20px; background:#f9fafb; padding:20px; border-radius:8px; border:1px solid #eef0f2;">
                                ...
                                <div class="mtop10">
                                    <button id="clear-signature" class="btn btn-default btn-sm" style="border-radius:6px; font-weight:600;"><i class="fa fa-eraser"></i> Clear Canvas</button>
                                </div>
                            </div>
                            
                            <button type="submit" class="btn btn-primary" style="background:#4a90e2; border:none; border-radius:6px; padding:10px 20px; font-weight:600; font-size:15px; box-shadow:0 4px 10px rgba(74,144,226,0.3);"><i class="fa fa-check"></i> Commit Status Update</button>
                            <?php echo form_close(); ?>
                        </div>
                        <div class="col-md-6">

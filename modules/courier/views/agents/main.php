...
.agents-topbar .btn { font-size: 13px; padding: 7px 16px; }
...
<div id="wrapper">
    <div class="content">
        ...
        <div class="agents-topbar">
            <h3><i class="fa fa-users" style="color:#27ae60;margin-right:8px;"></i> Agents</h3>
            <a href="<?php echo admin_url('courier/agents/main?group=create_agent'); ?>" class="btn btn-success">
                <i class="fa fa-plus"></i> Create Agent
            </a>
            <a href="<?php echo admin_url('courier/agents/main'); ?>" class="btn btn-default">
                <i class="fa fa-list"></i> List of Agents
            </a>
            <button id="sync-permissions-btn" class="btn btn-default" type="button">
...
$(function () {
    ...
    var SP_JSON_URL = '<?php echo admin_url("courier/settings/service_points_json"); ?>';

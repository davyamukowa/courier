                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px; margin-bottom:16px;">
                            <h4 class="font-bold m-0"><i class="fa fa-home menu-icon"></i><span style="margin-left:6px;">Courier Dashboard</span></h4>
                            <div style="display:flex; gap:8px; flex-wrap:wrap;">
                                <a href="<?php echo admin_url('courier/shipments/create'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> New Shipment</a>
                                <a href="<?php echo admin_url('courier/pickups/create'); ?>"  class="btn btn-default btn-sm" style="border:1px solid #555;"><i class="fa fa-truck"></i> New Pickup</a>
                                <a href="<?php echo admin_url('courier/shipments/main?group=manifests'); ?>" class="btn btn-default btn-sm" style="border:1px solid #555;"><i class="fa fa-file-text-o"></i> Manifests</a>
                            </div>
                        </div>
                        ...
                        .cdash-today-bar{display:flex;gap:16px;background:#e8f5e9;border:1px solid #c8e6c9;border-radius:6px;padding:10px 16px;margin:14px 0;font-size:13px;}
                        .cdash-today-bar span{display:flex;align-items:center;gap:6px;}
                        </style>

                        <!-- Today / Month quick stats -->
                        <div class="cdash-today-bar">
                            <span><i class="fa fa-calendar-o" style="color:#388e3c;"></i> <strong>Today:</strong> <?php echo (int)($today_count ?? 0); ?> shipment<?php echo ($today_count ?? 0) != 1 ? 's' : ''; ?></span>
                            <span><i class="fa fa-calendar" style="color:#1976d2;"></i> <strong>This Month:</strong> <?php echo (int)($month_count ?? 0); ?> shipment<?php echo ($month_count ?? 0) != 1 ? 's' : ''; ?></span>
                        </div>

                        <!-- Overview cards -->
                        <div class="cdash-stat-row">
                            <a href="<?php echo admin_url('courier/shipments?type=domestic'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier/pickups/index'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier/shipments?type=domestic&status=0'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier/companies/main'); ?>" class="cdash-stat-card">
                        ...
                        <div style="margin-top:28px;">
                            ...
                            <div style="display:flex; flex-wrap:wrap; gap:10px;">
                                <a href="<?php echo admin_url('courier/shipments/main'); ?>"        class="btn btn-default" style="border:2px solid #1976d2; color:#1976d2;"><i class="fa fa-globe"></i> Shipments</a>
                                <a href="<?php echo admin_url('courier/pickups/main'); ?>"          class="btn btn-default" style="border:2px solid #f57c00; color:#f57c00;"><i class="fa fa-truck"></i> Pickups</a>
                                <a href="<?php echo admin_url('courier/companies/main'); ?>"        class="btn btn-default" style="border:2px solid #28a745; color:#28a745;"><i class="fa fa-building"></i> Companies</a>
                                <a href="<?php echo admin_url('courier/agents/main'); ?>"           class="btn btn-default" style="border:2px solid #7b1fa2; color:#7b1fa2;"><i class="fa fa-users"></i> Agents</a>
                                <a href="<?php echo admin_url('courier/shipments/main?group=manifests'); ?>"   class="btn btn-default" style="border:2px solid #0097a7; color:#0097a7;"><i class="fa fa-file-text-o"></i> Manifests</a>
                                <a href="<?php echo admin_url('courier/shipments/list_invoices'); ?>" class="btn btn-default" style="border:2px solid #3949ab; color:#3949ab;"><i class="fa fa-file-text"></i> Invoices</a>
                                <a href="<?php echo admin_url('courier/settings/main'); ?>"        class="btn btn-default" style="border:2px solid #555;"><i class="fa fa-cogs"></i> Settings</a>
                                <a href="<?php echo base_url('courier/tracking'); ?>" target="_blank" class="btn btn-default" style="border:2px solid #00796b; color:#00796b;"><i class="fa fa-external-link"></i> Client Portal</a>
                            </div>
                        </div>
                        ...
                        <div style="margin-top:32px;">
                            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:10px;">
                                ...
                                <a href="<?php echo admin_url('courier/shipments'); ?>" class="btn btn-xs btn-default">View All</a>
                            </div>
                                ...
                                <table class="table table-hover table-bordered" style="font-size:13px;">
                                    ...
                                    <?php foreach ($recent_shipments as $s): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo admin_url('courier/shipments/waybill/' . $s->id); ?>" class="btn btn-xs btn-info" title="Waybill"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                        ...
                        <div style="margin-top:28px; text-align:center; color:#aaa; padding:24px 0;">
                            ...
                            <p>No shipments yet. <a href="<?php echo admin_url('courier/shipments/create'); ?>">Create the first one.</a></p>
                        </div>
                        <?php endif; ?>

...
function warehouse_appint(){
    // Local customization: disable external license verification.
    // Keep module bootstrap behavior unchanged for all warehouse features.
    return true;
}

function warehouse_preactivate($module_name){
    if ($module_name['system_name'] == WAREHOUSE_MODULE_NAME) {
        // Local customization: auto-activate module without purchase key/Envato username.
        return true;
    }
}
...
function warehouse_predeactivate($module_name){
    if ($module_name['system_name'] == WAREHOUSE_MODULE_NAME) {
        // Local customization: skip remote license deactivation.
        return true;
    }
}
...
function warehouse_uninstall($module_name){
    if ($module_name['system_name'] == WAREHOUSE_MODULE_NAME) {
        // Local customization: skip remote license deactivation on uninstall.
        return true;
    }
}

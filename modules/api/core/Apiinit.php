...
class Apiinit
{
    ...
    {
        return true; // license check bypassed — access managed by SaaS module
    ...
    {
        return; // integrity check bypassed — access managed by SaaS module
    ...
    {
        return; // activation gate bypassed — access managed by SaaS module
    }

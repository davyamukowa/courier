...
$current_date = date('Y-m-d');
				...
				?>
								...
								<?php if ($show_training == true) {?>
									<a href="<?php echo admin_url('xetuu_hr/trainings/detail/' . $r_value['training_id']); ?>"><?php echo '&nbsp;&nbsp;&nbsp;+' . new_html_entity_decode($r_value['training_name']); ?></a>
								<?php } else {?>
	...
	<div class="modal fade" id="education_sidebar" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<?php echo form_open_multipart(admin_url('xetuu_hr/trainings/save_update'), array('class' => 'save_update_education')); ?>

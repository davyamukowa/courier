        ...
        <table class="table border table-striped ">
          <tbody>
            ...
            <tr class="project-overview">
              ...
              <td>
                <?php echo new_html_entity_decode($driver->workplace ?? 'N/A') ?>
              </td>
            </tr>
            <tr class="project-overview">
              <td class="bold" width="40%"><?php echo _l('hr_status_label'); ?></td>
              <td>
                <?php echo new_html_entity_decode(_l($driver->status_work ?? 'N/A')) ?>
              </td>
            </tr>
            <tr class="project-overview">
              <td class="bold" width="40%"><?php echo _l('hr_hr_job_position'); ?></td>
              <td>
                <?php echo new_html_entity_decode($driver->job_position ?? 'N/A') ?>
              </td>
            </tr>
            <tr class="project-overview">

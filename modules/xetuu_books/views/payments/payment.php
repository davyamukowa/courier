...
<div class="tw-max-w-4xl tw-mx-auto tw-p-6">
    <div class="tw-mb-4 tw-flex tw-items-center">
        <a href="<?= admin_url('xetuu_books/invoice_form/' . $payment->invoiceid); ?>" class="btn btn-default btn-sm tw-mr-3">
    ...
    <h4 class="tw-mt-0 tw-font-bold tw-text-lg tw-text-neutral-700">
        ...
        <a href="<?= admin_url('xetuu_books/invoice_form/' . $payment->invoiceid); ?>">
                        ...
                        <div class="tw-self-start">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="hidden-xs">
                                        <a href="<?= admin_url('payments/pdf/' . $payment->paymentid . '?output_type=I'); ?>" target="_blank">
                                            <?= _l('view_pdf_in_new_window'); ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= admin_url('payments/pdf/' . $payment->paymentid); ?>">
                                            <?= _l('download'); ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= admin_url('payments/pdf/' . $payment->paymentid . '?print=true'); ?>" target="_blank">
                                            <?= _l('print'); ?>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="tw-text-neutral-600 tw-font-medium">
                                        <?= _l('payment_date'); ?>
                                        <span class="pull-right"><?= e(_d($payment->date)); ?></span>
                                    </p>
                                    <hr class="tw-my-2" />
                                    <p class="tw-text-neutral-600 tw-font-medium">
                                        ...
                                        <span class="pull-right">
                                            <?= e($payment->name); ?>
                                            <?php if (! empty($payment->paymentmethod)) { echo ' - ' . e($payment->paymentmethod); } ?>
                                        </span>
                                    </p>
                                    ...
                                    <p class="tw-text-neutral-600 tw-font-medium">
                                        ...
                                        <span class="pull-right"><?= e($payment->transactionid); ?></span>
                                    </p>
                                    <?php } ?>
                                </div>
                                ...
                                <table class="table table-bordered !tw-mt-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php if ($payment->invoice->status != Invoices_model::STATUS_PAID && $payment->invoice->status != Invoices_model::STATUS_CANCELLED) { ?>
                                            <th><span class="text-danger"><?= _l('invoice_amount_due'); ?></span></th>
                                            <?php } ?>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= e(_d($payment->invoice->date)); ?></td>
                                            <td><?= e(app_format_money($payment->invoice->total, $payment->invoice->currency_name)); ?></td>
                                            <td><?= e(app_format_money($payment->amount, $payment->invoice->currency_name)); ?></td>
                                            <?php if ($payment->invoice->status != Invoices_model::STATUS_PAID && $payment->invoice->status != Invoices_model::STATUS_CANCELLED) { ?>

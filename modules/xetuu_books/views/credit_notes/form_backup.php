...
<style>
/* Remove the generic wrapper padding so the invoice form fills edge-to-edge */
.xb-content-wrapper { padding: 0 !important; }

/* Xetuu Books credit note page chrome */
.xb-inv-topbar {
    display: flex;
    align-items: center;
...
.xb-inv-back:hover { color: #14532d; text-decoration: none; }
.xb-inv-title {
    font-size: 15px;
    font-weight: 700;
    color: #111827;
...
<div class="xb-inv-topbar">
    <div style="display:flex;align-items:center;">
        <a href="<?php echo admin_url('xetuu_books/credit_notes'); ?>" class="xb-inv-back">
            <i class="fa fa-arrow-left"></i> Back to Credit Notes
        </a>
        <div class="xb-inv-title"><?php echo $title; ?></div>
    </div>
</div>

<div class="xb-invoice-form" style="padding: 24px; background: #f9fafb; min-height: calc(100vh - 60px);">
    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="f_client_id">
                                    <div class="form-group select-placeholder">
                                        ...
                                        <select id="clientid" name="clientid" data-width="100%"
                                            class="<?php if (isset($credit_note) && empty($credit_note->clientid)) {
...
?>
                ...
                <div style="padding:0 20px 10px;">
                    <?php echo xb_render_analytic_field('xb_credit_note', isset($credit_note) ? $credit_note->id : 0, 'Analytic Account (Cost Centre)'); ?>
                </div>
                <?php endif; ?>

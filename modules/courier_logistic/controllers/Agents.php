...
class Agents extends AdminController
{
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() == FALSE || $file_error) {
            ...
            redirect('admin/courier_logistic/agents/main?group=create_agent');
        } else {
            ...
            redirect('admin/courier_logistic/agents/main?group=list_agents');
        }
    }
...
public function agent_number()
    ...
    public function view($id)
    {
        ...
        if (!$agent) {
            set_alert('danger', 'Agent not found.');
            redirect('admin/courier_logistic/agents/main');
        }
    ...
    {
        if (!$this->input->post()) {
            redirect('admin/courier_logistic/agents/edit/' . $id);
        }
        ...
        redirect('admin/courier_logistic/agents/view/' . $id);
    }

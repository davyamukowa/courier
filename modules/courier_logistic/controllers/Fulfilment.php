...
class Fulfilment extends AdminController
{
    public function __construct()
    {
        ...
        if (!has_permission('courier_logistic', '', 'view')) {
    ...
    {
        redirect(admin_url('courier_logistic/fulfilment/dashboard'));
    }
    ...
    public function dashboard()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/dashboard', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function orders()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/orders', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function salibay_order_list()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/salibay_order_list', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function get_salibay_order_list_datatable()
    {
        ...
        $base_sql = "
            ...
            WHERE 1=1
        ";
        $base_sql .= $this->branch_scope_sql_clause('so');
        ...
        foreach ($rows as $row) {
            ...
            if (!empty($row->shipment_id)) {
                ...
                $waybill_url = admin_url('courier_logistic/shipments/waybill/' . $row->shipment_id);
    ...
    public function inventory()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/inventory', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function health()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/health', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function settings()
    {
        ...
        $data['group_content'] = $this->load->view('courier_logistic/fulfilment/settings', $data, true);
        $this->load->view('courier_logistic/fulfilment/main', $data);
    }
    ...
    public function save_settings()
    {
        ...
        redirect(admin_url('courier_logistic/fulfilment/settings'));
    }
    ...
    public function get_orders_datatable()
    {
        ...
        foreach ($rows as $row) {
            ...
            if (!empty($row->gs_shipment_id)) {
                $shipment_cell = '<a href="' . admin_url('courier_logistic/shipments/waybill/' . $row->gs_shipment_id) . '">#' . (int) $row->gs_shipment_id . '</a>';
            }
            ...
            if (empty($row->gs_shipment_id)) {
                ...
                $actions .= '<li><a href="' . admin_url('courier_logistic/shipments/waybill/' . $row->gs_shipment_id) . '">Open Shipment</a></li>';
            }
     ...
     */
    private function branch_scope_sql_clause($alias)
    {
        if (courier_staff_can_view_all_branches()) {
            return '';
        }
    ...
    private function get_salibay_orders_for_list()
    {
        ...
        foreach ($rows as $row) {
            $row->order_badge_class = $this->order_badge_class($row->order_status);
            $row->financial_badge_class = $this->financial_badge_class($row->financial_status);
            $row->shipment_badge_class = $this->shipment_badge_class($row->status_name);
            $row->shipment_status_text = (string) ($row->status_description ?: (!empty($row->shipment_id) ? 'Shipment Created' : 'Awaiting Shipment'));
    ...
    private function create_courier_shipment($order_id)
    {
        ...
        return [
            ...
            'open_url' => admin_url('courier_logistic/shipments/waybill/' . $shipment_id),
        ];
    }
    ...
    private function create_shipment_invoice($shipment_id, $order, $recipient_data, $packages_data, $tracking_number)
    {
        ...
        $this->load->model('courier_logistic/Client_model', 'courier_client_model');
        $this->load->model('courier_logistic/Shipment_model', 'courier_shipment_model');

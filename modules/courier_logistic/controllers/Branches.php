...
class Branches extends AdminController
{
    public function __construct()
    {
        ...
        $this->load->model('courier_logistic/CourierBranch_model');
        $this->load->model('courier_logistic/CountryState_model');
    ...
    public function main()
    {
        ...
        $this->load->view('courier_logistic/branches/main', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            redirect(admin_url('courier_logistic/branches/main'));
            return;
        }

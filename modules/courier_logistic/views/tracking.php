...
$tab_urls = [
    'track'    => base_url('courier_logistic/track'),
    'quote'    => base_url('courier_logistic/get-a-quote'),
    'pickup'   => base_url('courier_logistic/schedule-delivery'),
    'service'  => base_url('courier_logistic/find-service-point'),
    'shipment' => base_url('courier_logistic/create-shipment'),
    'call'     => base_url('courier_logistic/call-for-booking'),
];
?>
<div class="tabs-bar">
...
<script>
    ...
    var QUOTE_CALC_URL    = '<?php echo base_url("courier_logistic/portal/calculate_quote"); ?>';
    var QUOTE_EMAIL_URL   = '<?php echo base_url("courier_logistic/portal/send_quote_email"); ?>';
    var COUNTRIES_URL     = '<?php echo base_url("courier_logistic/portal/get_countries"); ?>';
    var CITIES_URL        = '<?php echo base_url("courier_logistic/portal/get_cities"); ?>';
    var DOMESTIC_CITIES_URL = '<?php echo base_url("courier_logistic/portal/get_domestic_cities"); ?>';
    ...
    function trackShipment(trackingNumber) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_logistic/tracking/shipment_info"); ?>',
            type: 'POST',
    ...
    $('#public-pickup-form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_logistic/portal/store_pickup"); ?>',
            type: 'POST',
            data: form.serialize(),
            dataType: 'json',
            success: function (r) {
    ...
    $('#public-shipment-form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url("courier_logistic/portal/store_shipment"); ?>',
            type: 'POST',

<div class="row">
    <?php echo form_open('admin/courier_logistic/companies/store', ['id' => 'create-company-form']); ?>
    <div class="col-md-12">
        <div class="cgs-card">
                <div class="cgs-card__header">
                    <h4 class="cgs-card__title"><i class="fa fa-building"></i> Courier Logistic — Create Company</h4>
                    <div class="cgs-card__actions">
                        <a class="cgs-btn cgs-btn--outline" href="<?php echo admin_url('courier_logistic/companies/main?group=list_companies'); ?>">
                            View Companies
                        </a>
                    </div>
                </div>
                ...
                <section>
                    <div class="container-fluid">
                        ...
                        <button type="submit" class="cgs-btn cgs-btn--primary">Add Company</button>
                    </div>
                </section>
            </div>
        </div>

...
<?php $this->load->view('courier_logistic/layout/_topnav', ['cgs_active' => 'branches']); ?>
<div class="panel_s">
                        ...
                        <?php foreach ($branches as $branch): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (is_admin()): ?>
                                    <a href="<?php echo admin_url('courier_logistic/branches/delete/' . $branch->id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this branch? This only works if no staff are assigned to it.');">
...
<script>
var _branchCitiesUrl = '<?php echo admin_url('courier_logistic/branches/cities_by_country'); ?>';
...
function resetBranchModal() {
    ...
    document.getElementById('branchForm').action = '<?php echo admin_url('courier_logistic/branches/store'); ?>';
...
function openEditBranchModal(branch) {
    ...
    form.action = '<?php echo admin_url('courier_logistic/branches/update/'); ?>' + branch.id;

...
<script>
var PARCEL_RATE_SAVE_URL        = '<?php echo admin_url("courier_logistic/settings/save_parcel_rate"); ?>';
var TARIFF_UPLOAD_URL           = '<?php echo admin_url("courier_logistic/settings/upload_tariff_csv"); ?>';
var FCL_UPLOAD_URL              = '<?php echo admin_url("courier_logistic/settings/upload_fcl_csv"); ?>';
var TARIFF_DELETE_URL           = '<?php echo admin_url("courier_logistic/settings/delete_tariff_rate"); ?>';
var TARIFF_ZONE_URL             = '<?php echo admin_url("courier_logistic/settings/update_tariff_zone"); ?>';
var ORIGIN_TARIFF_UPLOAD_URL    = '<?php echo admin_url("courier_logistic/settings/upload_origin_tariff_csv"); ?>';
var ORIGIN_TARIFF_DELETE_URL    = '<?php echo admin_url("courier_logistic/settings/delete_origin_tariff"); ?>';
var ORIGIN_TARIFF_RATES_URL     = '<?php echo admin_url("courier_logistic/settings/origin_tariff_rates_json"); ?>';
var ORIGIN_TARIFF_TEMPLATE_URL  = '<?php echo admin_url("courier_logistic/settings/download_origin_tariff_template"); ?>';
var COUNTRIES_URL               = '<?php echo base_url("courier_logistic/portal/get_countries"); ?>';
var DOMESTIC_TARIFF_UPLOAD_URL   = '<?php echo admin_url("courier_logistic/settings/upload_domestic_tariff_csv"); ?>';
var DOMESTIC_TARIFF_DELETE_URL   = '<?php echo admin_url("courier_logistic/settings/delete_domestic_tariff"); ?>';
var DOMESTIC_TARIFF_RATES_URL    = '<?php echo admin_url("courier_logistic/settings/domestic_tariff_rates_json"); ?>';
var DOMESTIC_TARIFF_TEMPLATE_URL = '<?php echo admin_url("courier_logistic/settings/download_domestic_tariff_template"); ?>';
...
function deleteDomesticRate(id, origin, btn) {
    ...
    var fd = new FormData();
    fd.append(CSRF_TOKEN_NAME, CSRF_TOKEN_HASH);
    fetch('<?php echo admin_url("courier_logistic/settings/delete_domestic_tariff_rate"); ?>/' + id, { method: 'POST', body: fd })
        .then(function(r){ return r.json(); })
        .then(function(res) {
            if (res.success) {

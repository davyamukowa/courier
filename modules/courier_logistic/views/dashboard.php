            ...
            <div class="col-md-12">
                <div class="cgs-card">
                        ...
                        <div class="cgs-card__header">
                            <h4 class="cgs-card__title"><i class="fa fa-home"></i> Courier Logistic Dashboard</h4>
                            <div class="cgs-card__actions">
                                <a href="<?php echo admin_url('courier_logistic/shipments/create'); ?>" class="cgs-btn cgs-btn--primary cgs-btn--sm"><i class="fa fa-plus"></i> New Shipment</a>
                                <a href="<?php echo admin_url('courier_logistic/pickups/create'); ?>"  class="cgs-btn cgs-btn--outline cgs-btn--sm"><i class="fa fa-truck"></i> New Pickup</a>
                                <a href="<?php echo admin_url('courier_logistic/shipments/main?group=manifests'); ?>" class="cgs-btn cgs-btn--outline cgs-btn--sm"><i class="fa fa-file-text-o"></i> Manifests</a>
                            </div>
                        </div>
                        ...
                        <div class="cdash-stat-row">
                            <a href="<?php echo admin_url('courier_logistic/shipments?type=domestic'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier_logistic/pickups/index'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier_logistic/shipments?type=domestic&status=0'); ?>" class="cdash-stat-card">
                            ...
                            <a href="<?php echo admin_url('courier_logistic/companies/main'); ?>" class="cdash-stat-card">
                        ...
                        <div style="margin-top:28px;">
                            ...
                            <div style="display:flex; flex-wrap:wrap; gap:10px;">
                                <a href="<?php echo admin_url('courier_logistic/shipments/main'); ?>"        class="cgs-btn cgs-btn--outline"><i class="fa fa-globe"></i> Shipments</a>
                                <a href="<?php echo admin_url('courier_logistic/pickups/main'); ?>"          class="cgs-btn cgs-btn--outline"><i class="fa fa-truck"></i> Pickups</a>
                                <a href="<?php echo admin_url('courier_logistic/companies/main'); ?>"        class="cgs-btn cgs-btn--outline"><i class="fa fa-building"></i> Companies</a>
                                <a href="<?php echo admin_url('courier_logistic/agents/main'); ?>"           class="cgs-btn cgs-btn--outline"><i class="fa fa-users"></i> Agents</a>
                                <a href="<?php echo admin_url('courier_logistic/shipments/main?group=manifests'); ?>"   class="cgs-btn cgs-btn--outline"><i class="fa fa-file-text-o"></i> Manifests</a>
                                <a href="<?php echo admin_url('courier_logistic/shipments/list_invoices'); ?>" class="cgs-btn cgs-btn--outline"><i class="fa fa-file-text"></i> Invoices</a>
                                <a href="<?php echo admin_url('courier_logistic/settings/main'); ?>"        class="cgs-btn cgs-btn--outline"><i class="fa fa-cogs"></i> Settings</a>
                                <a href="<?php echo base_url('courier_logistic/tracking'); ?>" target="_blank" class="cgs-btn cgs-btn--accent"><i class="fa fa-external-link"></i> Client Portal</a>
                            </div>
                        </div>
                        ...
                        <div style="margin-top:32px;">
                            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:10px;">
                                ...
                                <a href="<?php echo admin_url('courier_logistic/shipments'); ?>" class="btn btn-xs btn-default">View All</a>
                            </div>
                                ...
                                <table class="table table-hover table-bordered cgs-table" style="font-size:13px;">
                                    ...
                                    <?php foreach ($recent_shipments as $s): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo admin_url('courier_logistic/shipments/waybill/' . $s->id); ?>" class="btn btn-xs btn-info" title="Waybill"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                        ...
                        <div style="margin-top:28px; text-align:center; color:#aaa; padding:24px 0;">
                            ...
                            <p>No shipments yet. <a href="<?php echo admin_url('courier_logistic/shipments/create'); ?>">Create the first one.</a></p>
                        </div>
                        <?php endif; ?>

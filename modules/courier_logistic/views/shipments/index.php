...
<?php $this->load->view('courier_logistic/layout/_topnav', ['cgs_active' => 'shipments']); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <?php $this->load->view('courier_logistic/shipments/_page_header', [
                    'header_context' => 'list',
                    'header_type' => $type,
                    'header_mode' => $mode,
                ...
                <div style="background-color:transparent;" class="panel_s">
                    <div style="padding:15px; margin-bottom:10px;">
                        <a style="text-decoration: none; border: 2px solid black;" class="custom-button"
                           href="<?php echo !empty($mode) ? admin_url('courier_logistic/shipments/create?type=' . $type . '&mode=' . $mode . '&mode_type=' . $mode_type) : admin_url('courier_logistic/shipments/create?type=' . $type); ?>">
                    ...
                    <div class="panel-body">
                        <div style="margin-bottom:20px; display: flex; justify-content: flex-end;">
                            <a style="text-decoration: none; border: 2px solid black; margin-left: 10px;"
                               class="custom-button"
                               href="<?php echo admin_url('courier_logistic/shipments/main?type=international'); ?>">
                        ...
                        <?php echo form_open(admin_url('courier_logistic/shipments/filter_shipments'), ['id' => 'filter-shipments-form']); ?>
...
$('#list_modal_send_btn').on('click', function () {
    ...
    $.ajax({
        url: '<?php echo admin_url('courier_logistic/shipments/send_waybill_email/'); ?>' + _listEmailShipmentId,
        type: 'POST',
        dataType: 'json',
        data: { email: email },
...
(function () {
    ...
    var _adminBase = '<?php echo admin_url('courier_logistic/shipments'); ?>';
...
<div class="modal fade" id="generateManifestModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?php echo form_open(admin_url('courier_logistic/shipments/generate_manifest'), ['id' => 'generate-manifest-form']); ?>
            <div class="modal-header">
...
var spm_payUrl     = '<?php echo admin_url('courier_logistic/shipments/record_courier_payment/'); ?>';
...
<script>
    $(document).ready(function () {
        ...
        document.getElementById('clearFilters').addEventListener('click', function () {
            ...
            $.ajax({
                url: '<?php echo admin_url("courier_logistic/shipments/clear_filters"); ?>',
                type: "POST",
                data: {

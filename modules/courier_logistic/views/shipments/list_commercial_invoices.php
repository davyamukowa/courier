            ...
            <div class="col-md-12">
                <div class="cgs-card">
                        ...
                        <div class="cgs-card__header">
                            ...
                            <a href="<?php echo admin_url('courier_logistic/shipments/main'); ?>"
                            ...
                            <table class="table dt-table cgs-table" id="ciTable"
                                ...
                                <?php foreach ($commercial_invoices as $ci): ?>
                                    ...
                                    $ci_url = !empty($ci->commercial_invoice_url)
                                        ...
                                        : admin_url('courier_logistic/shipments/commercial_invoice/' . $ci->id);
                                    $ci_target = !empty($ci->commercial_invoice_url) ? ' target="_blank"' : '';
                                    ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo admin_url('courier_logistic/shipments/waybill/' . $ci->id); ?>"

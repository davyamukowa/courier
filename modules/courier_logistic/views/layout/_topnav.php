...
$base = admin_url(COURIER_LOGISTIC_MODULE_NAME);

$CI =& get_instance();
$CI->load->model('courier_logistic/Driver_model');
$cgs_admin = is_admin();
...
<nav class="cgs-topnav">
    <div class="cgs-topnav__nav">
        ...
        <div class="cgs-topnav__item">
            <a href="<?php echo base_url('courier_logistic/tracking'); ?>" target="_blank" class="cgs-topnav__link">

...
?>
    ...
    <div class="cgs-card" style="margin-bottom:20px;">
        <div class="cgs-card__header" style="border-bottom:none;margin-bottom:0;padding-bottom:0;">
            ...
            <div class="cgs-card__actions">
                <a href="<?php echo admin_url('courier_logistic/agents/edit/' . $agent->id); ?>" class="cgs-btn cgs-btn--outline cgs-btn--sm">
                ...
                <?php if ($is_suspended): ?>
                    <a href="<?php echo admin_url('courier_logistic/agents/activate/' . $agent->id); ?>" class="cgs-btn cgs-btn--primary cgs-btn--sm" onclick="return confirm('Activate this agent?');">
                ...
                <?php endif; ?>
                <?php if (is_admin()): ?>
                    <a href="<?php echo admin_url('courier_logistic/agents/delete/' . $agent->id); ?>" class="cgs-btn cgs-btn--accent cgs-btn--sm" onclick="return confirm('Permanently delete this agent?');">
    ...
    <div class="tab-content agent-tab-content">
            ...
            <table class="table table-striped cgs-table">
                ...
                <?php foreach ($shipments as $s): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo admin_url('courier_logistic/shipments/waybill/' . $s->id); ?>" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
            ...
            <table class="table table-striped cgs-table">
                ...
                <?php foreach ($invoices as $inv): ?>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo admin_url('courier_logistic/shipments/courier_invoice/' . $inv->id); ?>" class="btn btn-xs btn-default"><i class="fa fa-file-text"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="tab-pane" id="tab-notes">
            <?php echo form_open(admin_url('courier_logistic/agents/update/' . $agent->id)); ?>
...
<div class="modal fade" id="resetPasswordModal" tabindex="-1">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('courier_logistic/agents/reset_password/' . $agent->id)); ?>
...
<div class="modal fade" id="suspendModal" tabindex="-1">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('courier_logistic/agents/suspend/' . $agent->id)); ?>
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
...
$(function () {
    $('#btn-save-permissions').on('click', function () {
        ...
        $.ajax({
            url:         '<?php echo admin_url('courier_logistic/agents/save_permissions/' . $agent->id); ?>',
            type:        'POST',
            data:        postData,
            dataType:    'json',

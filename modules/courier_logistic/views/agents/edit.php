                ...
                <div>
                    <?php echo form_open(admin_url('courier_logistic/agents/update/' . $agent->id)); ?>
                        ...
                        <div class="tw-flex tw-gap-2">
                            ...
                            <a href="<?php echo admin_url('courier_logistic/agents/view/' . $agent->id); ?>" class="cgs-btn cgs-btn--outline">Cancel</a>
                        </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p><a href="<?php echo admin_url('courier_logistic/agents/view/' . $agent->id); ?>" class="cgs-btn cgs-btn--outline" style="width:100%;justify-content:center;"><i class="fa fa-eye"></i> View Agent</a></p>
                    ...
                    <?php if (isset($agent->status) && ($agent->status === '0' || $agent->status == 0) && !empty($agent->suspended_at)): ?>
                        <p><a href="<?php echo admin_url('courier_logistic/agents/activate/' . $agent->id); ?>" class="cgs-btn cgs-btn--primary" style="width:100%;justify-content:center;" onclick="return confirm('Activate this agent?');"><i class="fa fa-check"></i> Activate Agent</a></p>
                    <?php else: ?>

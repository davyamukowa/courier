...
(function waitForJQueryFulfilmentHealth() {
    ...
    $(function () {
        $('.table-fulfilment-webhooks').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: admin_url + 'courier_logistic/fulfilment/get_webhook_events_datatable',
                type: 'POST',
                data: function(d) {
        ...
        $('.table-fulfilment-logs').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: admin_url + 'courier_logistic/fulfilment/get_logs_datatable',
                type: 'POST',
                data: function (d) {
...
function loadFulfilmentHealthStatus() {
    $.get(admin_url + 'courier_logistic/fulfilment/get_health_status', function (res) {
        if (!res.success) {
            return;
        }
...
function requeueFulfilmentWebhook(id) {
    $.post(admin_url + 'courier_logistic/fulfilment/requeue_webhook_event/' + id, function (res) {
...
function retryAllFulfilmentWebhooks() {
    $.post(admin_url + 'courier_logistic/fulfilment/retry_all_failed_webhooks', function (res) {
        alert_float(res.success ? 'success' : 'danger', res.message || 'Done.');
        $('.table-fulfilment-webhooks').DataTable().ajax.reload(null, false);
        loadFulfilmentHealthStatus();
    }, 'json');
...
function clearDoneFulfilmentEvents() {
    ...
    $.post(admin_url + 'courier_logistic/fulfilment/clear_done_events', function (res) {
        alert_float(res.success ? 'success' : 'danger', res.message || 'Done.');
        $('.table-fulfilment-webhooks').DataTable().ajax.reload(null, false);
        loadFulfilmentHealthStatus();
    }, 'json');
...
function viewFulfilmentPayload(id, type) {
    $.get(admin_url + 'courier_logistic/fulfilment/get_raw_data/' + type + '/' + id, function (res) {
        if (!res.success) {
...
function clearFulfilmentLogs() {
    ...
    $.post(admin_url + 'courier_logistic/fulfilment/clear_logs', function (res) {
        alert_float(res.success ? 'success' : 'danger', res.message || 'Done.');
...
function generateFulfilmentTestLog() {
    $.post(admin_url + 'courier_logistic/fulfilment/generate_test_log', function (res) {
        alert_float(res.success ? 'success' : 'danger', res.message || 'Done.');
        $('.table-fulfilment-logs').DataTable().ajax.reload(null, false);
    }, 'json');
}
...
function exportFulfilmentLogs() {
    var url = admin_url + 'courier_logistic/fulfilment/export_logs_csv'
...
function runFulfilmentInventorySync() {
    $.post(admin_url + 'courier_logistic/fulfilment/run_inventory_sync', function (res) {

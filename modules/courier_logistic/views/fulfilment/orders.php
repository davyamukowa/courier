...
(function waitForJQueryFulfilmentOrders() {
    ...
    $(function () {
        ...
        $('.table-fulfilment-orders').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: admin_url + 'courier_logistic/fulfilment/get_orders_datatable',
                type: 'POST',
                data: function (d) {
...
function viewFulfilmentOrder(id) {
    $.get(admin_url + 'courier_logistic/fulfilment/get_order_detail/' + id, function (res) {
        if (!res.success) {
        ...
        summary += '<p><strong>Shipment:</strong> ' + (order.gs_shipment_id ? '<a href="' + admin_url + 'courier_logistic/shipments/waybill/' + order.gs_shipment_id + '">#' + order.gs_shipment_id + '</a>' : 'None') + '</p>';
...
function createFulfilmentShipment(id) {
    ...
    $.post(admin_url + 'courier_logistic/fulfilment/create_shipment/' + id, function (res) {
        if (!res.success) {

...
<?php $this->load->view('courier_logistic/layout/_topnav', ['cgs_active' => 'fulfilment']); ?>
<style>
...
<section class="cgs-fulfilment-shell">
    <div class="cgs-fulfilment-header">
        ...
        <div class="cgs-fulfilment-nav">
            <a href="<?php echo admin_url('courier_logistic/fulfilment/dashboard'); ?>" class="<?php echo $group === 'dashboard' ? 'is-active' : ''; ?>"><i class="fa fa-dashboard"></i><span>Dashboard</span></a>
            <a href="<?php echo admin_url('courier_logistic/fulfilment/orders'); ?>" class="<?php echo $group === 'orders' ? 'is-active' : ''; ?>"><i class="fa fa-shopping-cart"></i><span>Orders</span></a>
            <a href="<?php echo admin_url('courier_logistic/fulfilment/inventory'); ?>" class="<?php echo $group === 'inventory' ? 'is-active' : ''; ?>"><i class="fa fa-cubes"></i><span>Virtual Warehouse</span></a>
            <a href="<?php echo admin_url('courier_logistic/fulfilment/health'); ?>" class="<?php echo $group === 'health' ? 'is-active' : ''; ?>"><i class="fa fa-heartbeat"></i><span>Health & Logs</span></a>
            <?php if ($can_manage_fulfilment): ?>
            <a href="<?php echo admin_url('courier_logistic/fulfilment/settings'); ?>" class="<?php echo $group === 'settings' ? 'is-active' : ''; ?>"><i class="fa fa-cogs"></i><span>Settings</span></a>
            <?php endif; ?>
        </div>

                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($order->shipment_id)): ?>
                                        <a href="<?php echo admin_url('courier_logistic/shipments/waybill/' . $order->shipment_id); ?>" style="font-weight:700;">
                                ...
                                <td>
                                    <?php if (!empty($order->shipment_id)): ?>
                                        <a href="<?php echo admin_url('courier_logistic/shipments/waybill/' . $order->shipment_id); ?>" class="btn btn-default btn-xs">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    <?php else: ?>
...
function createSalibayShipment(id) {
    ...
    $.post('<?php echo site_url('admin/courier_logistic/fulfilment/create_shipment/'); ?>' + id, postData, function (res) {
        if (!res.success) {

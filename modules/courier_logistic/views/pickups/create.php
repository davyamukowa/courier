...
<style>
    ...
    .select2-selection__arrow {
        ...
        <div class="row">
            <?php echo form_open('admin/courier_logistic/pickups/store', ['id' => 'create-pickup-form']); ?>
            <div class="col-md-12">
                <div class="cgs-card">
                        <div class="cgs-card__header">
                            <h4 class="cgs-card__title"><i class="fa fa-truck"></i> Courier Logistic — Create Pickup</h4>
                            <div class="cgs-card__actions">
                                ...
                                <a class="cgs-btn cgs-btn--outline cgs-btn--sm"
                                   href="<?php echo admin_url('courier_logistic/pickups/index'); ?>">
                                    <i class="fa fa-list"></i> View Pickups
                                </a>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="cgs-btn cgs-btn--primary">Add pickup</button>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
    ...
    $(document).ready(function () {
        ...
        function getStates(countryId) {
            ...
            $.ajax({
                ...
                error: function () {
                    sel.html('<option value="">Could not load states</option>');
                }
            });
        }

        // Auto-load states for the currently selected country on page load

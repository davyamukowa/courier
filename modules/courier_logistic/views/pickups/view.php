...
<style>
    ...
    <div style="padding: 20px 30px;">
        ...
        <div class="exec-dashboard-header">
            <div>
                <h2>Courier Logistic — Pickup Request #<?php echo $pickup['id'] ?? ''; ?></h2>
                <p>Real-time overview of pickup logistics and analytics.</p>
            </div>
            <div>
                <a href="<?php echo admin_url('courier_logistic/pickups'); ?>" class="cgs-btn cgs-btn--outline">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-value">
                            <?php if(!empty($pickup['shipment_id'])): ?>
                                <a href="<?php echo admin_url('courier_logistic/shipments/view/'.$pickup['shipment_id']); ?>" style="font-weight:700;">#<?php echo $pickup['shipment_id']; ?></a>
                            <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <div class="signature-box">
                                ...
                                <?php if (!empty($pickup['signature_url'])): ?>
                                    <img src="<?php echo base_url('modules/courier_logistic/' . $pickup['signature_url']); ?>" />
                                <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <div class="signature-box">
                                ...
                                <?php if (!empty($pickup['delivery_signature_url'])): ?>
                                    <img src="<?php echo base_url('modules/courier_logistic/' . $pickup['delivery_signature_url']); ?>" />
                                <?php else: ?>
                                    <p class="text-muted" style="margin:20px 0;"><small>Pending</small></p>
                                <?php endif; ?>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="exec-card border-top-purple">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo form_open('admin/courier_logistic/pickups/update_status/', ['id' => 'update-status-pickup-form']); ?>

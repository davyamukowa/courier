            ...
            <div class="col-md-12">
                <div class="cgs-card">
                        <div class="cgs-card__header">
                            <h4 class="cgs-card__title"><i class="fa fa-truck"></i> Courier Logistic — Pickups</h4>
                            <div class="cgs-card__actions">
                                <a class="cgs-btn cgs-btn--outline cgs-btn--sm"
                                   href="<?php echo admin_url('courier_logistic/pickups/main'); ?>">
                                    <i class="fa fa-arrow-left" aria-hidden="true"></i> Pickup Dashboard
                                </a>
                                <a class="cgs-btn cgs-btn--primary cgs-btn--sm"
                                   href="<?php echo admin_url('courier_logistic/pickups/create'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($pickup->signature_url)): ?>
                                                <img width="40" height="40"
                                                     src="<?php echo base_url('modules/courier_logistic/' . $pickup->signature_url); ?>"
                                        ...
                                        <td>
                                            <?php if (!empty($pickup->delivery_signature_url)): ?>
                                                <img width="40" height="40"
                                                     src="<?php echo base_url('modules/courier_logistic/' . $pickup->delivery_signature_url); ?>"
                                        ...
                                        <td class="align-left" style="white-space: nowrap;">
                                            <div class="d-flex flex-row justify-content-center" style="gap:4px;">
                                                ...
                                                <a href="<?php echo admin_url('courier_logistic/pickups/view/' . $pickup->id); ?>"
                                                   class="cgs-btn cgs-btn--primary cgs-btn--sm" title="View Pickup">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?php echo admin_url('courier_logistic/pickups/delete/' . $pickup->id); ?>"
...
<div class="modal fade" id="update_status" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/courier_logistic/pickups/update_status/', ['id' => 'update-pickup-form']); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var bulkUrl  = '<?php echo admin_url("courier_logistic/pickups/bulk_delete"); ?>';
        ...
        $('#pickups-table').on('click', 'tbody tr', function(e) {
            ...
            if (id) {
                window.location.href = '<?php echo admin_url("courier_logistic/pickups/view/"); ?>' + id;
            }
        });
